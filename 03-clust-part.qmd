...
- Ubicación de partida de los centroides mediante el algoritmo *k-means++* [@arthur2007].

### Implementaciones y mejoras en *k*-means

- Paper con la evolución de métodos y optimizaciones para resolver *k*-means.
...
Descripción y ejemplos de implementación
